...
for dish in dishes:
    ...
    dish_title = dish.select_one(
        'div.common_sp_caption > div.common_sp_caption_tit.line2').text
    dish_star = dish.select_one(
        'div.common_sp_caption > div.common_sp_caption_rv > span.common_sp_caption_rv_star')
