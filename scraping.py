...
def get_urls():
    ...
    data = requests.get('https://www.10000recipe.com/ranking/home_new.html', headers=headers)
    ...
    lis = soup.select('#contents_area_full > div > ul > li')
...
get_urls()
# https://www.10000recipe.com/recipe/list.html?q=%EC%88%98%EB%AF%B8%EB%84%A4
